...
2. Fill in the project form:
   ...
   **Basic Information:**
   ...
   - **Department**: Select which department this project belongs to (optional but recommended)
   ...
   **Team:**
   ...
   - **Team Members**: People working on the project (Hold Ctrl/Cmd to select multiple)
   - **Client**: External client or stakeholder (from user list or enter external name)

   **Budget:**
   - **Allocated Budget**: Total budget for this project
   - **Currency**: Select currency (USD, EUR, GBP, INR, AUD, CAD)
   - **Profit Margin**: Expected profit percentage

   **Location:**
   - **Country**: Project location
   - **Timezone**: For scheduling purposes (with major timezone options)

3. Click **"Create Project"**

**TIP:** Assigning a department allows you to see this project's budget breakdown in the Departments page!
...
### Viewing Project Budgets Within Departments

**NEW FEATURE!** Each department now shows a detailed breakdown of all projects assigned to it.

#### How to View Project Breakdown

1. Find the department in the table
2. Click the **▶ arrow button** in the first column
3. The row expands to show all projects in that department

#### What You'll See in the Project Breakdown

When you expand a department, you'll see a detailed table with:

| Column | Description | Example |
|--------|-------------|---------|
| **Project Name** | Full name of the project | "Website Redesign" |
| **Project Code** | Unique project identifier | "WEB-2024-001" |
| **Status** | Current project phase | ACTIVE, COMPLETED, PLANNING |
| **Allocated Budget** | Total budget for this project | $50,000 |
| **Spent** | Amount already spent on project | $25,000 |
| **Remaining** | Budget left for project | $25,000 |

**Status Color Coding:**
- 🟢 **Green (ACTIVE)**: Project is currently running
- 🔵 **Blue (COMPLETED)**: Project is finished
- ⚪ **Gray (PLANNING)**: Project is being planned
- 🟡 **Yellow (ON HOLD)**: Project is paused

**Budget Color Coding:**
- 🟢 **Green text**: Under budget (positive remaining)
- 🔴 **Red text**: Over budget (negative remaining)

#### Total Row

At the bottom of each project breakdown, you'll see a **Total row** showing:
- Sum of all project budgets in the department
- Sum of all project spending
- Total remaining budget across all projects

#### Why This is Useful

✅ **Track Multiple Projects**: See exactly which projects are consuming budget
✅ **Compare Projects**: Quickly identify which projects are over/under budget
✅ **Budget Planning**: Understand where department money is allocated
✅ **Project Codes**: Each project has a unique code for tracking
✅ **Real-time Data**: See current spending vs allocated amounts

#### Linking Projects to Departments

When creating a new project (from Dashboard or Tasks page), you can now select which department the project belongs to. This automatically includes it in the department's project breakdown.
